...
RSpec.feature 'Create a Media, CT stack', js: true do
  context 'a logged in user' do
    ...
    scenario do
        ...
        fill_in('X spacing', with: 'test')
        fill_in('Y spacing', with: 'test')
        fill_in('Z spacing', with: 'test')
        select('Feet', from: 'Unit')
