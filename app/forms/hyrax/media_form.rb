...
module Hyrax
  ...
  class MediaForm < Hyrax::Forms::WorkForm
    ...
    self.terms = [:modality, :media_type, :x_spacing, :y_spacing, :z_spacing, :slice_thickness,
                    :scale_bar, :unit, :map_type, :series_type,
    ...
    self.single_valued_fields = [:media_type, :cite_as, :legacy_media_file_id, :legacy_media_group_id, :uuid, :ark, :doi, :available, :x_spacing, :y_spacing, :z_spacing, :slice_thickness, :series_type, :unit]
