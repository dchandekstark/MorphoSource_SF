...
module Hyrax
  ...
  class MediaForm < Hyrax::Forms::WorkForm
    ...
    self.terms = [:title, :modality, :media_type, :x_spacing, :y_spacing, :z_spacing,
                    :scale_bar_target_type, :scale_bar_distance, :scale_bar_units, :scale_bar, :unit, :map_type,
    ...
    self.single_valued_fields = [:title, :media_type, :cite_as, :legacy_media_file_id, :legacy_media_group_id, :uuid, :ark, :doi, :available, :x_spacing, :y_spacing, :z_spacing, :scale_bar_target_type, :scale_bar_distance, :scale_bar_units, :unit]
