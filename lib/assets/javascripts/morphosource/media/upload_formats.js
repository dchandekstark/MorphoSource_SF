...
function mediaTypeFormats() {
  ...
  let allFormats = ".avi, .bmp, .dcm, .dicom, .gif, .gltf, .jp2, .jpeg, .jpg, .m4v, .mov, .mp4, .mpg, .mpeg, .mtl, .obj, .pdf, .ply, .png, .stl, .tif, .tiff, .wmv, .wrl, .x3d, .zip";
  let formats = {};
  ...
  switch (mediaType) {
    ...
    case 'PhotogrammetryImageStack':
      ...
      break;
    case 'Mesh':
      var list = ".bmp, .dcm, .dicom, .gif, .gltf, .jp2, .jpeg, .jpg, .mtl, .obj, .ply, .png, .stl, .tif, .tiff, .wrl, .x3d, .zip"
      break;
    case 'Other':
      var list = allFormats;
      break;
