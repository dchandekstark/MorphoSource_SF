Hyrax.config do |config|
  ...
  config.derivatives_path = ENV.fetch("DERIVATIVES_PATH", Rails.root.join("public", "derivatives"))
  ...
  # mount point.
  #
  config.whitelisted_ingest_dirs = ENV.fetch('WHITELISTED_INGEST_DIRS', '').split(':').presence || []
end
